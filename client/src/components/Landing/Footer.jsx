...
const Footer = () => {
  return (
    <footer className="home-footer">
      <h1 className="heading heading--primary center-content"><span className="highlight">Contact Us</span></h1>
      <div className="home-footer__main">
        ...
        <div className="home-footer--center">
          <form action="" className="form home-footer__form">
            ...
            <div className="form__group">
            <textarea className="form__input" name="contact-message" cols="30" rows="2" placeholder="Enter your Query"></textarea>
                <label for="email" className="form__label">Email address</label>
            </div>
          </form>
        </div>
